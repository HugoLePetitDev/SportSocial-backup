...
export class PopUpCoachComponent implements OnInit {
  ...
  constructor(private CoachService: CoachService, private http: HttpClient, public dark: DarkThemeService, iconRegistry: MatIconRegistry, sanitizer: DomSanitizer) {
